...
function Driver() {
  ...
  const hendleSubmitDocVerify = () => {
    ...
    dispatch(adminAction.documentsApprove(data, { page: 1, role_id: 9 }))
    setDocVerifyU(false)
  }
  ...
  const hendleToaddPerUpdate = (e: any) => {
    ...
    setImagesUpdate([{ data_url: URL.API_BASE_URL + e.dl_doc }])
  ...
  const hendleTosubmitUpdate = () => {
    ...
    data.append('dl_number', updateDoc?.dl_number)
    ...
    if (imagesUpdate[0]?.file) {
      // roledata?.role_name
      data.append('dl_doc', imagesUpdate[0]?.file)
    }

    dispatch(adminAction.documents_update(data, { page: 1, role_id: 9 }))
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      if (seleceteRole?.shortname == 'vendor') {
        ...
        setSelectedVendor(get_user_profile?.profile)
      }
    }, 1000)
  }, [get_user_profile, get_role_list]);
    ...
    try {
      ...
      if (seleceteRole?.shortname == 'user' || seleceteRole?.shortname == 'vendor') {
        ...
        if (!roledata?.name) {
          ...
          data.append('aen_id', seleceteMangerAen?.id)
          data.append('jen_id', seleceteMangerJen?.id)
          await dispatch(adminAction.createuserAndDriver(data, { page: 1, role_id: 9 }))
          setShow(false)
          setLoading(false)
          setseleceteMangerXen(null)
          setseleceteMangerAen(null)
      ...
      dispatch(adminAction.getuserRoleWise({ page: pageNo, role_id: 9, search }))
  ...
  const hendleTosubmit = () => {
    ...
    data.append('dl_number', roledataDoc?.dl_number)
    ...
    dispatch(adminAction.documents(data, { page: 1, role_id: 9 }))
  ...
  const hendleToAcctive = (e: any, active: any) => {
    ...
    dispatch(adminAction.activeInactive(data, { page: 1, role_id: 9 }))
    dispatch(adminAction.getuserRoleWise({ page: pageNo, role_id: 9, search }))
  }
      ...
      <div className='d-flex flex-column flex-column-fluid'>
        <div id='kt_app_toolbar' className='app-toolbar py-3 py-lg-6'>
          ...
          >
            <Modal show={show} dialogClassName='modal-90w' onHide={handleClose}>
              ...
              <Modal.Body>
                <div className='row'>
                  ...
                  <div className='mb-7 fv-row col-3' style={{ display: 'none' }}>
                    <label className='form-label mb-2 fw-semibold fs-6'>
                      <span className='required'> Circle </span>
                    </label>
                    <select
              ...
              <Modal.Body>
                ...
                <div className='mb-10'>
                  ...
                  <div className='mb-7 fv-row'>
                    ...
                    <input
                      // className='form-control form-control-solid'
                      placeholder='Enter a  aadhar number'
                      name='aadhar_number'
                      onChange={(e: any) => {
                        const { name, value } = e.target;
                  ...
                  <div className='mb-7 fv-row'>
                    <label className='form-label mb-2 fw-semibold fs-6'>
                      <span className='required'>dl Image</span>
                      <i
                        className='ms-2 fas fa-exclamation-circle fs-7'
                        data-bs-toggle='popover'
                        data-bs-trigger='hover'
                  ...
                  <div className='mb-7 fv-row'>
                    <label className='form-label mb-2 fw-semibold fs-6'>
                      <span className='required'> dl number</span>
                      <i
                        className='ms-2 fas fa-exclamation-circle fs-7'
                        data-bs-toggle='popover'
                        data-bs-trigger='hover'
            ...
            <Modal show={addpermissionUpdate} onHide={handleCloseaddpermissionUpdate}>
              ...
              <Modal.Body>
                ...
                <div className='mb-10'>
                  ...
                  <div className='mb-7 fv-row'>
                    <label className='form-label mb-2 fw-semibold fs-6'>
                      <span className='required'>aadhar number 2</span>
                      <i
                        className='ms-2 fas fa-exclamation-circle fs-7'
                        data-bs-toggle='popover'
                        data-bs-trigger='hover'
                    ...
                    <input
                      ...
                      onChange={(e: any) => {
                        ...
                        if (/^-?\d*\.?\d*$/.test(value)) {
                          hendleUpdateDocUpdate({ target: { name: "aadhar_number", value } });
                        }
                      }}
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title id='example-custom-modal-styling-title'>Driver Details</Modal.Title>
              </Modal.Header>
              <Modal.Body>
             ...
             */}
                  ...
                  >
                    ...
                    <div className='col-3'>
                      <p>{get_users_details?.documents?.dl_number}</p>
                    </div>
                    ...
                    <div className='col-3'>
                      ...
                      <div
                        style={{ width: '100px' }}
                        onClick={(e) => {
                          onclickView(URL.API_BASE_URL + get_users_details?.documents?.dl_doc)
                        }}
                      >
                        <img
                          style={{ width: '100%' }}
                          src={URL.API_BASE_URL + get_users_details?.documents?.dl_doc}
                          alt=''
                        />
                      </div>
                    </div>
            ...
            <div className='d-flex flex-column flex-wrap justify-content-center me-3 page-title'>
              ...
              <ul className='my-0 breadcrumb-separatorless pt-1 fw-semibold breadcrumb fs-7'>
                ...
                <li className='breadcrumb-item text-muted'>Driver</li>
              </ul>
            </div>
                        ...
                        <tr key={i}>
                          ...
                          <td>
                            ...
                            <button
                              ...
                              disabled={seleceteRole?.shortname === "vendor"}
                              className={
                                data?.active
                          ...
                          <td>
                            ...
                            {data?.documents?.docs_verified !== 'Verify' && seleceteRole?.shortname !== "vendor"
                              && data?.documents ? (
                              <button
                                data-id='2209'
                                onClick={() => {
